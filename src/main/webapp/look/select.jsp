...
<head>
    ...
    <link rel="stylesheet" href="/js/lookall/css/bootstrap.min.css">                                  <!-- https://getbootstrap.com/ -->
    <link rel="stylesheet" href="/js/lookall/fontawesome/css/fontawesome-all.min.css">                <!-- https://fontawesome.com/ -->
    <link rel="stylesheet" type="text/css" href="/js/lookall/slick/slick.css"/>                       <!-- http://kenwheeler.github.io/slick/ -->
    <link rel="stylesheet" type="text/css" href="/js/lookall/slick/slick-theme.css"/>
    <link rel="stylesheet" href="/js/lookall/css/tooplate-style.css">
    ...
    <div class="tm-main-content">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-6 col-md-col-xl-6 mb-md-0 mb-sm-4 mb-4 tm-site-header-col">
                    <div class="tm-site-header">
                        ...
                        <img src="/js/lookall/img/underline.png" class="img-fluid mb-4">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="content">
                        <div class="grid">
                            <div class="grid__item" id="home-link">
                                <div class="product">
                                    ...
                                    <div class="product__description">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                <img src="/js/lookall/img/welcome-1.jpg" class="img-fluid mb-3">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                ...
                                                <img src="/js/lookall/img/welcome-2.jpg" class="img-fluid">
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-sm-4 p-2">
                                            ...
                                            <div class="row tm-reverse-sm">
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-lg-0 mb-sm-4 mb-4">
                                                    <img src="/js/lookall/img/team.jpg" class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tlinks">Collect from <a href="http://www.cssmoban.com/" >留给点击返回上一层</a></div>
                                                ...
                                                <div class="col-12">
                                                    <div class="p-sm-4 p-2 tm-img-container">
                                                        <div class="tm-img-slider" id="tmImgSlider">
                                                            <img src="/js/lookall/img/gallery-img-01-tn.jpg" alt="Image" class="tm-slider-img">
                                                            <img src="/js/lookall/img/gallery-img-02-tn.jpg" alt="Image" class="tm-slider-img">
                                                            <img src="/js/lookall/img/gallery-img-03-tn.jpg" alt="Image" class="tm-slider-img">
                                                            <img src="/js/lookall/img/gallery-img-04-tn.jpg" alt="Image" class="tm-slider-img">
                                                            <img src="/js/lookall/img/gallery-img-05-tn.jpg" alt="Image" class="tm-slider-img">
                                                            <img src="/js/lookall/img/gallery-img-06-tn.jpg" alt="Image" class="tm-slider-img">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="product">
                                    ...
                                    <div class="product__description">
                                        <div class="pt-sm-4 pb-sm-4 pl-sm-5 pr-sm-5 pt-2 pb-2 pl-3 pr-3">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <form action="/js/lookall/index.html" method="post" class="contact-form">
                                                        <div class="row">
        ...
        <footer>
            <p class="small tm-copyright-text">Copyright &copy; <span class="tm-current-year">2018</span> Your Company.
                ...
                Layout: <a rel="nofollow" href="#/view/2097-pop" class="tm-text-highlight">Pop Design</a> More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">进入下一界面</a></p>
        </footer>
    </div> <!-- .tm-main-content -->
</div>
<!-- load JS -->
<script src="/js/lookall/js/jquery-3.2.1.slim.min.js"></script>         <!-- https://jquery.com/ -->
<script src="/js/lookall/slick/slick.min.js"></script>                  <!-- http://kenwheeler.github.io/slick/ -->
<script src="/js/lookall/js/anime.min.js"></script>                     <!-- http://animejs.com/ -->
<script src="/js/lookall/js/main.js"></script>
<script src="/js/lookall/js/long.js"></script>
