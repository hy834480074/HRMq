        ...
        $(function () {
            ...
            $(":text[name='resumeTel']").blur(function() {
                ...
                if(isPhoneNo(resumeTel)==false ){
                    ...
                    $("form").attr("action","/resume/resumeAddResume");
                    $("form").submit("");
                }
            })
...
<div id="foreground" class="wall">
    <form class="form-inline"  action ="/resume/resumeAddResume">
        ...
        <table  border="0">
            <tr>
                <div class="form-group">
                    ...
                    <td>
                        <input type="text" class="form-control" name="resumeName" id="exampleInputName2" placeholder="Jane Doe" required="required">
                    </td>
                    ...
                    <td>
                        <input type="text" name="resumeCity" class="form-control" id="exampleInputName2" placeholder="Jane Doe">
                    </td>
                </div>
            </tr>
            <tr>
                <div class="form-group">
                    ...
                    <td>
                        <input type="text" class="form-control" id="exampleInputName2" placeholder="Jane Doe" name="resumeTel" required="required">
                    </td>
                    <td>
                        <label for="exampleInputEmail2" >邮箱:</label>
                    </td>
                    <td>
                        <input type="email" name="resumeEmail" class="form-control" id="exampleInputEmail2" required="required" placeholder="jane.doe@example.com">
                    </td>
                </div>
            </tr>
            ...
            <tr>
                <div class="form-group">
                    ...
                    <td colspan="2">
                        <input type="text" name="resumExperient" class="form-control" id="exampleInputName2" placeholder="Jane Doe">
